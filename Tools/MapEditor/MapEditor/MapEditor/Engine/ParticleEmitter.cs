    ...
    public class ParticleEmitter
    {
        ...
        public virtual void Draw(Microsoft.Xna.Framework.GameTime gameTime, Microsoft.Xna.Framework.Graphics.GraphicsDevice gDev, Microsoft.Xna.Framework.Vector2 drawPos)
        {
            ...
            for (int i = 0; i < particles.Count; i++)
            {
                ...
                particles[i] = new Microsoft.Xna.Framework.Vector4(x, y, particles[i].Z - decay, particles[i].W);

                //if (Microsoft.Xna.Framework.Vector2.Distance(new Microsoft.Xna.Framework.Vector2(particles[i].X, particles[i].Y), origin) > lifeSpan)
                if (particles[i].Z < 0 || (decay < 1 && !new Microsoft.Xna.Framework.Rectangle(0, 0, gDev.Viewport.Width, gDev.Viewport.Height).
                ...
                sB.Draw(type.texture, new Microsoft.Xna.Framework.Rectangle((int)(particles[i].X - drawPos.X), (int)(particles[i].Y - drawPos.Y), type.width, type.height),
                    new Microsoft.Xna.Framework.Rectangle(0, 0, type.width, type.height), type.hue, particles[i].W, new Microsoft.Xna.Framework.Vector2(type.width >> 1, type.height >> 1),
